 ...
 */
class getSallesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SallesRepository' shared autowired service.
     *
     * @return \App\Repository\SallesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SallesRepository.php';

        return $container->privates['App\\Repository\\SallesRepository'] = new \App\Repository\SallesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
