 ...
 */
class getManifestationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ManifestationsRepository' shared autowired service.
     *
     * @return \App\Repository\ManifestationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ManifestationsRepository.php';

        return $container->privates['App\\Repository\\ManifestationsRepository'] = new \App\Repository\ManifestationsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
